...
public class DatePickerDailog extends Dialog {
	...
	public DatePickerDailog(Context context, Calendar calendar,
		...
		XmlResourceParser xrp = Mcontex.getResources().getXml(R.drawable.selector_txt_boton_redondo);  
		try {  
		    ColorStateList csl = ColorStateList.createFromXml(Mcontex.getResources(), xrp);  
		    btnset.setTextColor(csl); 
		} catch (Exception e) {  } 

		
		btnset.setBackgroundResource(R.drawable.selector_btn_generic);
		btncancel.setText("Cancelar");
		XmlResourceParser xrp2 = Mcontex.getResources().getXml(R.drawable.selector_txt_boton_redondo);  
		try {  
		    ColorStateList csl = ColorStateList.createFromXml(Mcontex.getResources(), xrp2);  
		    btncancel.setTextColor(csl); 
		} catch (Exception e) {  } 
		btncancel.setBackgroundResource(R.drawable.selector_btn_generic);
		...
		lytdate.setBackgroundColor(Color.BLACK);
	...
	private class DateNumericAdapter extends NumericWheelAdapter {
		...
		protected void configureTextView(TextView view) {
			...
			if (currentItem == currentValue) {
				view.setTextColor(context.getResources().getColor(R.color.generic_amarillo));
			}
