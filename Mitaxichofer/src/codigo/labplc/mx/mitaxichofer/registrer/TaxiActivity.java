...
import codigo.labplc.mx.mitaxichofer.registrer.servicios.ServicioGeolocalizacion;
/**
 * 
 * @author mikesaurio
 *
...
//	SocketIO socket;//socket para la conección con el servidor
	...
	//	socket=new SocketConnection().connection();
		...
		btnStopService.setOnClickListener(new OnClickListener() {
			public void onClick(View view) {
				...
				tvCoordenadas.setText("esperando");//regresamos a texto default
	...
	private BroadcastReceiver onBroadcast = new BroadcastReceiver() {
		...
		public void onReceive(Context ctxt, Intent i) {
				...
				if (tvCoordenadas.getText().equals("esperando")) {
